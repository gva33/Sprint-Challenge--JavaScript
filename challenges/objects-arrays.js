...
zooAnimals.forEach(function(x){
  return animalNames.push("Name: " + x.animal_name + ", Scientific: " + x.scientific_name +".");
});
...
*/
const lowerPopulation = zooAnimals.filter(function(num){
...
const total = zooAnimals.reduce(function(accumulator, animal) {
